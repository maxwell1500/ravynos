...
BEGIN {
	...
	print  "#define NCURSES_VERSION \"6.6\""
	print  ""
	...
	print  "#define NCURSES_SP_FUNCS 20251230"
	...
	print  "#undef  GET_TTY"
	print  ""
	print  "#if 1 && 1	/* #if HAVE_TERMIOS_H && HAVE_TCGETATTR */"
	print  ""
	print  "#undef  TERMIOS"
