...
CC_CONST CC_INLINE cc_size cczp_n(cczp_const_t zp)
{
	return CCZP_CONST_T_ZP(zp)->n;
}
...
CC_CONST CC_INLINE const cc_unit *cczp_prime(cczp_const_t zp)
{
	return CCZP_CONST_T_U(zp) + ccn_nof_size(sizeof(struct cczp));
}
