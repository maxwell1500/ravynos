...
machine_startup(void)
{
	...
	const char *ms1 = "Step 14: machine_startup entered...\r\n";
	while (*ms1) { pal_serial_putc(*ms1++); }
	...
	const char *ms2 = "Step 15: calling kernel_bootstrap()...\r\n";
	while (*ms2) { pal_serial_putc(*ms2++); }
