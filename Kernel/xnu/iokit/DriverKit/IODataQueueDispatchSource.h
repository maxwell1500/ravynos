/* iig(DriverKit-254) generated from IODataQueueDispatchSource.iig */
...
public:
	...
	static kern_return_t
	CanEnqueueData(uint32_t callerDataSize) LOCALONLY;

	static kern_return_t
	CanEnqueueData(uint32_t callerDataSize, uint32_t dataCount) LOCALONLY;
