# This script was generated from '/nest/ncurses/man/man_db.renames' by man/make_sed.sh.
# Do the TH lines
...
s/TH \<color_content 3X /TH color_content 3NCURSES /
...
s/TH \<erasechar 3X /TH erasechar 3NCURSES /
s/TH \<erasewchar 3X /TH erasewchar 3NCURSES /
...
s/TH \<noraw 3X /TH noraw 3NCURSES /
...
s/TH \<reset_prog_mode 3X /TH reset_prog_mode 3NCURSES /
...
s/TH \<tigetflag 3X /TH tigetflag 3NCURSES /
s/TH \<tigetnum 3X /TH tigetnum 3NCURSES /
...
s/TH \<ungetch 3X /TH ungetch 3NCURSES /
...
s/TH \<waddnstr 3X /TH waddnstr 3NCURSES /
s/TH \<waddnwstr 3X /TH waddnwstr 3NCURSES /
...
s/TH \<wget_wstr 3X /TH wget_wstr 3NCURSES /
s/TH \<wgetch 3X /TH wgetch 3NCURSES /
s/TH \<wgetstr 3X /TH wgetstr 3NCURSES /
s/TH \<win_wch 3X /TH win_wch 3NCURSES /
...
s/TH \<wunctrl 3X /TH wunctrl 3NCURSES /
...
s/\<fB\(\\%\)\?captoinfo\\fP(1M)/fB\1captoinfo\\fP(1)/
s/\<fB\(\\%\)\?clear\\fP(1)/fB\1clear\\fP(1)/
s/\<fB\(\\%\)\?curs_add_wch\\fP(3X)/fB\1add_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_add_wchstr\\fP(3X)/fB\1add_wchstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_addch\\fP(3X)/fB\1addch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_addchstr\\fP(3X)/fB\1addchstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_addstr\\fP(3X)/fB\1addstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_addwstr\\fP(3X)/fB\1addwstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_attr\\fP(3X)/fB\1attr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_beep\\fP(3X)/fB\1beep\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_bkgd\\fP(3X)/fB\1bkgd\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_bkgrnd\\fP(3X)/fB\1bkgrnd\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_border\\fP(3X)/fB\1border\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_border_set\\fP(3X)/fB\1border_set\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_clear\\fP(3X)/fB\1clear\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_color\\fP(3X)/fB\1color\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_delch\\fP(3X)/fB\1delch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_deleteln\\fP(3X)/fB\1deleteln\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_extend\\fP(3X)/fB\1extensions\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_get_wch\\fP(3X)/fB\1get_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_get_wstr\\fP(3X)/fB\1get_wstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_getcchar\\fP(3X)/fB\1getcchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_getch\\fP(3X)/fB\1getch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_getstr\\fP(3X)/fB\1getstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_getyx\\fP(3X)/fB\1getyx\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_in_wch\\fP(3X)/fB\1in_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_in_wchstr\\fP(3X)/fB\1in_wchstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_inch\\fP(3X)/fB\1inch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_inchstr\\fP(3X)/fB\1inchstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_initscr\\fP(3X)/fB\1initscr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_inopts\\fP(3X)/fB\1inopts\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_ins_wch\\fP(3X)/fB\1ins_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_ins_wstr\\fP(3X)/fB\1ins_wstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_insch\\fP(3X)/fB\1insch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_insstr\\fP(3X)/fB\1insstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_instr\\fP(3X)/fB\1instr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_inwstr\\fP(3X)/fB\1inwstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_kernel\\fP(3X)/fB\1kernel\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_legacy\\fP(3X)/fB\1legacy\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_memleaks\\fP(3X)/fB\1memleaks\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_mouse\\fP(3X)/fB\1mouse\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_move\\fP(3X)/fB\1move\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_opaque\\fP(3X)/fB\1opaque\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_outopts\\fP(3X)/fB\1outopts\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_overlay\\fP(3X)/fB\1overlay\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_pad\\fP(3X)/fB\1pad\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_print\\fP(3X)/fB\1print\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_printw\\fP(3X)/fB\1printw\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_refresh\\fP(3X)/fB\1refresh\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_scanw\\fP(3X)/fB\1scanw\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_scr_dump\\fP(3X)/fB\1scr_dump\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_scroll\\fP(3X)/fB\1scroll\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_slk\\fP(3X)/fB\1slk\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_sp_funcs\\fP(3X)/fB\1sp_funcs\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_termattrs\\fP(3X)/fB\1termattrs\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_termcap\\fP(3X)/fB\1termcap\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_terminfo\\fP(3X)/fB\1terminfo\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_threads\\fP(3X)/fB\1threads\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_touch\\fP(3X)/fB\1touch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_trace\\fP(3X)/fB\1trace\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_util\\fP(3X)/fB\1util\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_variables\\fP(3X)/fB\1curses_variables\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_window\\fP(3X)/fB\1window\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curses\\fP(3X)/fB\1ncurses\\fP(3NCURSES)/
s/\<fB\(\\%\)\?default_colors\\fP(3X)/fB\1default_colors\\fP(3NCURSES)/
s/\<fB\(\\%\)\?define_key\\fP(3X)/fB\1define_key\\fP(3NCURSES)/
s/\<fB\(\\%\)\?form\\fP(3X)/fB\1form\\fP(3FORM)/
s/\<fB\(\\%\)\?form_cursor\\fP(3X)/fB\1cursor\\fP(3FORM)/
s/\<fB\(\\%\)\?form_data\\fP(3X)/fB\1data\\fP(3FORM)/
s/\<fB\(\\%\)\?form_driver\\fP(3X)/fB\1driver\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field\\fP(3X)/fB\1field\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_attributes\\fP(3X)/fB\1field_attributes\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_buffer\\fP(3X)/fB\1field_buffer\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_info\\fP(3X)/fB\1field_info\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_just\\fP(3X)/fB\1field_just\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_new\\fP(3X)/fB\1field_new\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_opts\\fP(3X)/fB\1field_opts\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_userptr\\fP(3X)/fB\1field_userptr\\fP(3FORM)/
s/\<fB\(\\%\)\?form_field_validation\\fP(3X)/fB\1field_validation\\fP(3FORM)/
s/\<fB\(\\%\)\?form_fieldtype\\fP(3X)/fB\1fieldtype\\fP(3FORM)/
s/\<fB\(\\%\)\?form_hook\\fP(3X)/fB\1hook\\fP(3FORM)/
s/\<fB\(\\%\)\?form_new\\fP(3X)/fB\1new\\fP(3FORM)/
s/\<fB\(\\%\)\?form_new_page\\fP(3X)/fB\1new_page\\fP(3FORM)/
s/\<fB\(\\%\)\?form_opts\\fP(3X)/fB\1opts\\fP(3FORM)/
s/\<fB\(\\%\)\?form_page\\fP(3X)/fB\1page\\fP(3FORM)/
s/\<fB\(\\%\)\?form_post\\fP(3X)/fB\1post\\fP(3FORM)/
s/\<fB\(\\%\)\?form_requestname\\fP(3X)/fB\1requestname\\fP(3FORM)/
s/\<fB\(\\%\)\?form_userptr\\fP(3X)/fB\1userptr\\fP(3FORM)/
s/\<fB\(\\%\)\?form_variables\\fP(3X)/fB\1form_variables\\fP(3FORM)/
s/\<fB\(\\%\)\?form_win\\fP(3X)/fB\1win\\fP(3FORM)/
s/\<fB\(\\%\)\?infocmp\\fP(1M)/fB\1infocmp\\fP(1)/
s/\<fB\(\\%\)\?infotocap\\fP(1M)/fB\1infotocap\\fP(1)/
s/\<fB\(\\%\)\?key_defined\\fP(3X)/fB\1key_defined\\fP(3NCURSES)/
s/\<fB\(\\%\)\?keybound\\fP(3X)/fB\1keybound\\fP(3NCURSES)/
s/\<fB\(\\%\)\?keyok\\fP(3X)/fB\1keyok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?legacy_coding\\fP(3X)/fB\1legacy_coding\\fP(3NCURSES)/
s/\<fB\(\\%\)\?menu\\fP(3X)/fB\1menu\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_attributes\\fP(3X)/fB\1attributes\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_cursor\\fP(3X)/fB\1cursor\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_driver\\fP(3X)/fB\1driver\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_format\\fP(3X)/fB\1format\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_hook\\fP(3X)/fB\1hook\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_items\\fP(3X)/fB\1items\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_mark\\fP(3X)/fB\1mark\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_new\\fP(3X)/fB\1new\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_opts\\fP(3X)/fB\1opts\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_pattern\\fP(3X)/fB\1pattern\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_post\\fP(3X)/fB\1post\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_requestname\\fP(3X)/fB\1requestname\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_spacing\\fP(3X)/fB\1spacing\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_userptr\\fP(3X)/fB\1userptr\\fP(3MENU)/
s/\<fB\(\\%\)\?menu_win\\fP(3X)/fB\1win\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_current\\fP(3X)/fB\1menu_current\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_name\\fP(3X)/fB\1menu_name\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_new\\fP(3X)/fB\1menu_new\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_opts\\fP(3X)/fB\1menu_opts\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_userptr\\fP(3X)/fB\1menu_userptr\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_value\\fP(3X)/fB\1menu_value\\fP(3MENU)/
s/\<fB\(\\%\)\?mitem_visible\\fP(3X)/fB\1menu_visible\\fP(3MENU)/
s/\<fB\(\\%\)\?ncurses\\fP(3X)/fB\1ncurses\\fP(3NCURSES)/
s/\<fB\(\\%\)\?new_pair\\fP(3X)/fB\1new_pair\\fP(3NCURSES)/
s/\<fB\(\\%\)\?panel\\fP(3X)/fB\1panel\\fP(3NCURSES)/
s/\<fB\(\\%\)\?printf\\fP(3S)/fB\1printf\\fP(3)/
s/\<fB\(\\%\)\?putc\\fP(3S )/fB\1putc\\fP(3)/
s/\<fB\(\\%\)\?resizeterm\\fP(3X)/fB\1resizeterm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?scanf\\fP(3S)/fB\1scanf\\fP(3)/
s/\<fB\(\\%\)\?scr_dump\\fP(5)/fB\1scr_dump\\fP(5)/
s/\<fB\(\\%\)\?system\\fP(3S)/fB\1system\\fP(3)/
s/\<fB\(\\%\)\?tabs\\fP(1)/fB\1tabs\\fP(1)/
s/\<fB\(\\%\)\?term\\fP(5)/fB\1term\\fP(5)/
s/\<fB\(\\%\)\?term\\fP(7)/fB\1term\\fP(7)/
s/\<fB\(\\%\)\?term_variables\\fP(3X)/fB\1terminfo_variables\\fP(3NCURSES)/
s/\<fB\(\\%\)\?terminfo\\fP(5)/fB\1terminfo\\fP(5)/
s/\<fB\(\\%\)\?tic\\fP(1M)/fB\1tic\\fP(1)/
s/\<fB\(\\%\)\?toe\\fP(1M)/fB\1toe\\fP(1)/
s/\<fB\(\\%\)\?tput\\fP(1)/fB\1tput\\fP(1)/
s/\<fB\(\\%\)\?tset\\fP(1)/fB\1tset\\fP(1)/
s/\<fB\(\\%\)\?user_caps\\fP(5)/fB\1user_caps\\fP(5)/
s/\<fB\(\\%\)\?wresize\\fP(3X)/fB\1wresize\\fP(3NCURSES)/
s/\<fB\(\\%\)\?add_wch\\fP(3X)/fB\1add_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?addch\\fP(3X)/fB\1addch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?assume_default_colors\\fP(3X)/fB\1assume_default_colors\\fP(3NCURSES)/
s/\<fB\(\\%\)\?attr_get\\fP(3X)/fB\1attr_get\\fP(3NCURSES)/
s/\<fB\(\\%\)\?attr_on\\fP(3X)/fB\1attr_on\\fP(3NCURSES)/
s/\<fB\(\\%\)\?attron\\fP(3X)/fB\1attron\\fP(3NCURSES)/
s/\<fB\(\\%\)\?baudrate\\fP(3X)/fB\1baudrate\\fP(3NCURSES)/
s/\<fB\(\\%\)\?beep\\fP(3X)/fB\1beep\\fP(3NCURSES)/
s/\<fB\(\\%\)\?bkgd\\fP(3X)/fB\1bkgd\\fP(3NCURSES)/
s/\<fB\(\\%\)\?bkgrnd\\fP(3X)/fB\1bkgrnd\\fP(3NCURSES)/
s/\<fB\(\\%\)\?cbreak\\fP(3X)/fB\1cbreak\\fP(3NCURSES)/
s/\<fB\(\\%\)\?clearok\\fP(3X)/fB\1clearok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?clrtoeol\\fP(3X)/fB\1clrtoeol\\fP(3NCURSES)/
s/\<fB\(\\%\)\?color_content\\fP(3X)/fB\1color_content\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curs_set\\fP(3X)/fB\1curs_set\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curscr\\fP(3X)/fB\1curscr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?curses_trace\\fP(3X)/fB\1curses_trace\\fP(3NCURSES)/
s/\<fB\(\\%\)\?def_prog_mode\\fP(3X)/fB\1def_prog_mode\\fP(3NCURSES)/
s/\<fB\(\\%\)\?def_shell_mode\\fP(3X)/fB\1def_shell_mode\\fP(3NCURSES)/
s/\<fB\(\\%\)\?del_curterm\\fP(3X)/fB\1del_curterm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?delay_output\\fP(3X)/fB\1delay_output\\fP(3NCURSES)/
s/\<fB\(\\%\)\?delscreen\\fP(3X)/fB\1delscreen\\fP(3NCURSES)/
s/\<fB\(\\%\)\?derwin\\fP(3X)/fB\1derwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?doupdate\\fP(3X)/fB\1doupdate\\fP(3NCURSES)/
s/\<fB\(\\%\)\?echo\\fP(3X)/fB\1echo\\fP(3NCURSES)/
s/\<fB\(\\%\)\?endwin\\fP(3X)/fB\1endwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?erasechar\\fP(3X)/fB\1erasechar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?erasewchar\\fP(3X)/fB\1erasewchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?extended_slk_color\\fP(3X)/fB\1extended_slk_color\\fP(3NCURSES)/
s/\<fB\(\\%\)\?filter\\fP(3X)/fB\1filter\\fP(3NCURSES)/
s/\<fB\(\\%\)\?flushinp\\fP(3X)/fB\1flushinp\\fP(3NCURSES)/
s/\<fB\(\\%\)\?get_wch\\fP(3X)/fB\1get_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?get_wstr\\fP(3X)/fB\1get_wstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getattr\\fP(3X)/fB\1getattr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getcchar\\fP(3X)/fB\1getcchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getch\\fP(3X)/fB\1getch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getstr\\fP(3X)/fB\1getstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getwin\\fP(3X)/fB\1getwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getyx\\fP(3X)/fB\1getyx\\fP(3NCURSES)/
s/\<fB\(\\%\)\?halfdelay\\fP(3X)/fB\1halfdelay\\fP(3NCURSES)/
s/\<fB\(\\%\)\?has_key\\fP(3X)/fB\1has_key\\fP(3NCURSES)/
s/\<fB\(\\%\)\?idcok\\fP(3X)/fB\1idcok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?idlok\\fP(3X)/fB\1idlok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?immedok\\fP(3X)/fB\1immedok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?in_wch\\fP(3X)/fB\1in_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?inch\\fP(3X)/fB\1inch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?init_color\\fP(3X)/fB\1init_color\\fP(3NCURSES)/
s/\<fB\(\\%\)\?initscr\\fP(3X)/fB\1initscr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?is_cbreak\\fP(3X)/fB\1is_cbreak\\fP(3NCURSES)/
s/\<fB\(\\%\)\?is_scrollok\\fP(3X)/fB\1is_scrollok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?keyname\\fP(3X)/fB\1keyname\\fP(3NCURSES)/
s/\<fB\(\\%\)\?keypad\\fP(3X)/fB\1keypad\\fP(3NCURSES)/
s/\<fB\(\\%\)\?killchar\\fP(3X)/fB\1killchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?killwchar\\fP(3X)/fB\1killwchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?leaveok\\fP(3X)/fB\1leaveok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?longname\\fP(3X)/fB\1longname\\fP(3NCURSES)/
s/\<fB\(\\%\)\?meta\\fP(3X)/fB\1meta\\fP(3NCURSES)/
s/\<fB\(\\%\)\?mousemask\\fP(3X)/fB\1mousemask\\fP(3NCURSES)/
s/\<fB\(\\%\)\?move\\fP(3X)/fB\1move\\fP(3NCURSES)/
s/\<fB\(\\%\)\?mvcur\\fP(3X)/fB\1mvcur\\fP(3NCURSES)/
s/\<fB\(\\%\)\?mvwin\\fP(3X)/fB\1mvwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?newpad\\fP(3X)/fB\1newpad\\fP(3NCURSES)/
s/\<fB\(\\%\)\?newterm\\fP(3X)/fB\1newterm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?newwin\\fP(3X)/fB\1newwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?nl\\fP(3X)/fB\1nl\\fP(3NCURSES)/
s/\<fB\(\\%\)\?nocbreak\\fP(3X)/fB\1nocbreak\\fP(3NCURSES)/
s/\<fB\(\\%\)\?nodelay\\fP(3X)/fB\1nodelay\\fP(3NCURSES)/
s/\<fB\(\\%\)\?nonl\\fP(3X)/fB\1nonl\\fP(3NCURSES)/
s/\<fB\(\\%\)\?noraw\\fP(3X)/fB\1noraw\\fP(3NCURSES)/
s/\<fB\(\\%\)\?notimeout\\fP(3X)/fB\1notimeout\\fP(3NCURSES)/
s/\<fB\(\\%\)\?pnoutrefresh\\fP(3X)/fB\1pnoutrefresh\\fP(3NCURSES)/
s/\<fB\(\\%\)\?prefresh\\fP(3X)/fB\1prefresh\\fP(3NCURSES)/
s/\<fB\(\\%\)\?printw\\fP(3X)/fB\1printw\\fP(3NCURSES)/
s/\<fB\(\\%\)\?putp\\fP(3X)/fB\1putp\\fP(3NCURSES)/
s/\<fB\(\\%\)\?putwin\\fP(3X)/fB\1putwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?raw\\fP(3X)/fB\1raw\\fP(3NCURSES)/
s/\<fB\(\\%\)\?refresh\\fP(3X)/fB\1refresh\\fP(3NCURSES)/
s/\<fB\(\\%\)\?reset_prog_mode\\fP(3X)/fB\1reset_prog_mode\\fP(3NCURSES)/
s/\<fB\(\\%\)\?reset_shell_mode\\fP(3X)/fB\1reset_shell_mode\\fP(3NCURSES)/
s/\<fB\(\\%\)\?restartterm\\fP(3X)/fB\1restartterm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?ripoffline\\fP(3X)/fB\1ripoffline\\fP(3NCURSES)/
s/\<fB\(\\%\)\?scrollok\\fP(3X)/fB\1scrollok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?set_curterm\\fP(3X)/fB\1set_curterm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?set_term\\fP(3X)/fB\1set_term\\fP(3NSES)/
s/\<fB\(\\%\)\?setcchar\\fP(3X)/fB\1setcchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?setupterm\\fP(3X)/fB\1setupterm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?slk_attr\\fP(3X)/fB\1slk_attr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?slk_color\\fP(3X)/fB\1slk_color\\fP(3NCURSES)/
s/\<fB\(\\%\)\?slk_init\\fP(3X)/fB\1slk_init\\fP(3NCURSES)/
s/\<fB\(\\%\)\?slk_touch\\fP(3X)/fB\1slk_touch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?start_color\\fP(3X)/fB\1start_color\\fP(3NCURSES)/
s/\<fB\(\\%\)\?subwin\\fP(3X)/fB\1subwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?syncok\\fP(3X)/fB\1syncok\\fP(3NCURSES)/
s/\<fB\(\\%\)\?terminfo\\fP(3X)/fB\1terminfo\\fP(3NCURSES)/
s/\<fB\(\\%\)\?tigetflag\\fP(3X)/fB\1tigetflag\\fP(3NCURSES)/
s/\<fB\(\\%\)\?tigetnum\\fP(3X)/fB\1tigetnum\\fP(3NCURSES)/
s/\<fB\(\\%\)\?tigetstr\\fP(3X)/fB\1tigetstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?touchline\\fP(3X)/fB\1touchline\\fP(3NCURSES)/
s/\<fB\(\\%\)\?touchwin\\fP(3X)/fB\1touchwin\\fP(3NCURSES)/
s/\<fB\(\\%\)\?tparm\\fP(3X)/fB\1tparm\\fP(3NCURSES)/
s/\<fB\(\\%\)\?tputs\\fP(3X)/fB\1tputs\\fP(3NCURSES)/
s/\<fB\(\\%\)\?trace\\fP(3X)/fB\1trace\\fP(3NCURSES)/
s/\<fB\(\\%\)\?unctrl\\fP(3X)/fB\1unctrl\\fP(3NCURSES)/
s/\<fB\(\\%\)\?ungetch\\fP(3X)/fB\1ungetch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?use_default_colors\\fP(3X)/fB\1use_default_colors\\fP(3NCURSES)/
s/\<fB\(\\%\)\?use_env\\fP(3X)/fB\1use_env\\fP(3NCURSES)/
s/\<fB\(\\%\)\?use_extended_names\\fP(3X)/fB\1use_extended_names\\fP(3NCURSES)/
s/\<fB\(\\%\)\?use_legacy_coding\\fP(3X)/fB\1use_legacy_coding\\fP(3NCURSES)/
s/\<fB\(\\%\)\?use_tioctl\\fP(3X)/fB\1use_tioctl\\fP(3NCURSES)/
s/\<fB\(\\%\)\?vidputs\\fP(3X)/fB\1vidputs\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wadd_wch\\fP(3X)/fB\1wadd_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?waddch\\fP(3X)/fB\1waddch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?waddnstr\\fP(3X)/fB\1waddnstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?waddnwstr\\fP(3X)/fB\1waddnwstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?waddstr\\fP(3X)/fB\1waddstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?waddwstr\\fP(3X)/fB\1waddwstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wattr_set\\fP(3X)/fB\1wattr_set\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wattrset\\fP(3X)/fB\1wattrset\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wbkgdset\\fP(3X)/fB\1wbkgdset\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wbkgrndset\\fP(3X)/fB\1wbkgrndset\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wdelch\\fP(3X)/fB\1wdelch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wecho_wchar\\fP(3X)/fB\1wecho_wchar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wechochar\\fP(3X)/fB\1wechochar\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wget_wch\\fP(3X)/fB\1wget_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wget_wstr\\fP(3X)/fB\1wget_wstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wgetch\\fP(3X)/fB\1wgetch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wgetstr\\fP(3X)/fB\1wgetstr\\fP(3NCURSES)/
s/\<fB\(\\%\)\?win_wch\\fP(3X)/fB\1win_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?winch\\fP(3X)/fB\1winch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wins_wch\\fP(3X)/fB\1wins_wch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?winsch\\fP(3X)/fB\1winsch\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wmove\\fP(3X)/fB\1wmove\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wnoutrefresh\\fP(3X)/fB\1wnoutrefresh\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wrefresh\\fP(3X)/fB\1wrefresh\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wsetscrreg\\fP(3X)/fB\1wsetscrreg\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wtimeout\\fP(3X)/fB\1wtimeout\\fP(3NCURSES)/
s/\<fB\(\\%\)\?wunctrl\\fP(3X)/fB\1wunctrl\\fP(3NCURSES)/
s/\<fB\(\\%\)\?getty\\fP(8)/fB\1getty\\fP(8)/
s/\<fB\(\\%\)\?scanf\\fP(3)/fB\1scanf\\fP(3)/
s/\<fB\(\\%\)\?ttys\\fP(5)/fB\1ttys\\fP(4)/
s/\<fB\(\\%\)\?system\\fP(3)/fB\1system\\fP(3)/
s/\<fB\(\\%\)\?regcomp\\fP(3X)/fB\1regcomp\\fP(3)/
s/\<fB\(\\%\)\?regexec\\fP(3X)/fB\1regexec\\fP(3)/
s/\<fB\(\\%\)\?vprintf\\fP(3)/fB\1vprintf\\fP(3)/
s/\<fB\(\\%\)\?adacurses6-config\\fP(1)/fB\1adacurses6-config\\fP(1)/
s/\<fB\(\\%\)\?ncurses6-config\\fP(1)/fB\1ncurses6-config\\fP(1)/
...
s/^\\fBcolor_content\\f[RP] -/\\fBcolor_content\\fP -/
...
s/^\\fBerasechar\\f[RP] -/\\fBerasechar\\fP -/
s/^\\fBerasewchar\\f[RP] -/\\fBerasewchar\\fP -/
...
s/^\\fBreset_prog_mode\\f[RP] -/\\fBreset_prog_mode\\fP -/
...
s/^\\fBterminfo\\f[RP] -/\\fBterminfo\\fP -/
s/^\\fBtigetflag\\f[RP] -/\\fBtigetflag\\fP -/
s/^\\fBtigetnum\\f[RP] -/\\fBtigetnum\\fP -/
...
s/^\\fBwaddnstr\\f[RP] -/\\fBwaddnstr\\fP -/
s/^\\fBwaddnwstr\\f[RP] -/\\fBwaddnwstr\\fP -/
...
s/^\\fBwget_wstr\\f[RP] -/\\fBwget_wstr\\fP -/
s/^\\fBwgetch\\f[RP] -/\\fBwgetch\\fP -/
s/^\\fBwgetstr\\f[RP] -/\\fBwgetstr\\fP -/
s/^\\fBwin_wch\\f[RP] -/\\fBwin_wch\\fP -/
...
s/^\\fBadacurses6-config\\f[RP] -/\\fBadacurses6-config\\fP -/
s/^\\fBncurses6-config\\f[RP] -/\\fBncurses6-config\\fP -/
