...
smr_cpu_init(struct processor *processor)
{
	...
	const char *s1 = "    smr_cpu_init: entering...\r\n";
	...
	const char *s2 = "    smr_cpu_init: getting smr_worker...\r\n";
	...
	const char *s4 = "    smr_cpu_init: smrq_init and mpsc_queue_init...\r\n";
	...
	const char *s5 = "    smr_cpu_init: completed successfully!\r\n";
	while (*s5) { pal_serial_putc(*s5++); }
}
