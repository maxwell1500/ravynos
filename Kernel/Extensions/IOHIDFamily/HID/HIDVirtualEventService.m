...
#import <IOKit/hid/IOHIDServiceClientPrivate.h>
#import <IOKit/hid/IOHIDEventSystemKeysPrivate.h>
...
IOHIDEventRef IOHIDVirtualServiceClientDispatchEvent(
    IOHIDServiceClientRef client,
    IOHIDEventRef event)
{
    NSLog(@"IOHIDVirtualServiceClientDispatchEvent: STUB client=%p event=%p",
          client, event);
}
