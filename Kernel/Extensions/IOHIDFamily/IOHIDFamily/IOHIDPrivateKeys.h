 ...
 */
/* Modified 2026 by Zoe Knox for ravynOS. This note is in support of clause
 * 2.2 of the License
 */
...
/* Technically private - don't use outside HID */
enum {
    kIOHIDVirtualServiceNoFlags = 0,
    kIOHIDVirtualServiceScheduledWithDispatchQueue = 1,
    kIOHIDVirtualServiceUnScheduledFromDispatchQueue = 2,
