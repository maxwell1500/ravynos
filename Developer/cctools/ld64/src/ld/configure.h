...
#define DEFAULT_MACOSX_MIN_VERSION "12.0"
...
#define ALL_SUPPORTED_ARCHS  "i386 x86_64 x86_64h armv6 armv7 armv7s armv7m armv7k arm64 arm64e arm64_32"
#define BITCODE_XAR_VERSION "1.0"
#define LD64_VERSION_NUM 609
