/* iig(DriverKit-254 Oct 18 2022 12:24:09) generated from IOUserClient.iig */
    ...
    switch (msg->msgid)
    {
        ...
        case IOUserClient_KernelCompletion_ID:
        {
            if (__builtin_available(driverkit 20, *)) {
                ...
                ret = IOUserClient::AsyncCompletion_Invoke(rpc, self, SimpleMemberFunctionCast(IOUserClient::AsyncCompletion_Handler, *self, &IOUserClient::KernelCompletion_Impl));
            }
            break;
        }
#endif /* !KERNEL */
...
IOUserClient::CreateActionKernelCompletion(size_t referenceSize, OSAction ** action)
{
    ...
    if (__builtin_available(driverkit 20, *)) {
        ...
        ret = OSAction_IOUserClient_KernelCompletion::Create(this,
